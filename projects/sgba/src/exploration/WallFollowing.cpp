...
void exploration::WallFollowing::command_turn_around_corner_and_adjust(
    float *vel_x, float *vel_y, float *vel_w, float radius, float range) const {
	*vel_x = max_speed;
...
void exploration::WallFollowing::command_turn_and_adjust(
    float *vel_y, float *vel_w, float rate, float /*range*/) const {
